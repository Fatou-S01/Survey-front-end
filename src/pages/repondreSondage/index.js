...
const handleSliderChange = (event, newValue) => {
  ...
  return(
    ...
    <div style={{display:'flex',justifyContent:'center', marginTop:'15px'}}>
    <button onClick={() => {SaveAnswer(params.id_sondage)}} style= {{color: '#fff', backgroundColor: '#2a9e9e', borderStyle: 'solid',borderRadius: '6px',borderColor:'#2a9e9e', height: '30px',width:'100px'}}>Envoyer</button>
    </div>
    </form>
