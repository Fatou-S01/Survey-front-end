  ...
  return(
    ...
    <div style={{paddingLeft:'5%', paddingRight:'5%', marginTop:'20px', marginBottom: '10px'}}>
      ...
      <Modal
        ...
        footer={[
          <Button key="back" onClick={handleCancel} style= {{color:'#2a9e9e'}}>
            Annuler
          </Button>,
          <Button key="submit" loading={loading} onClick={handleOk} style= {{backgroundColor: '#2a9e9e', color:'#fff'}}>
            {send == 0 ? "Envoyer" : "Copier"}
          </Button>,
      ...
      >
        ...
        {
          send == 0 ? <Mail/> : <Link1 link={`localhost:3000/repondreSondage/${params.id_sondage}`}/>
        }
      </Modal>
